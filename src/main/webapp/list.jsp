...
<body>
	...
	<main>
		<!-- 締め切りまでの時間を表示する -->
		<p id="deadline_time">締め切りまで0:00:00</p>
...
//締め切り時間までのカウントダウン
	...
	try {
	  const res = await fetch('/bentou/_time',{method: 'POST'});
 ...
 function updateRemainingTime() {
 	 ...
 	 if (diffMs < 0) {
 	 	document.getElementById("deadline_time").textContent ='締め切りが過ぎました！';
 	 	...
 	 	//残り時間の分と秒は二桁表示にする
 	 		document.getElementById("deadline_time").textContent ='締め切りまで' + diffHours+':'
